    ...
    <table>
      <tr>
        ...
        <td>
          ...
          <br>
          즐거운 것이 많고 영정이 가득한 20때의 시절을 뒤돌아보면은 박진감(迫眞感)이 있는 느낌을 니끼고 좋아하고 만족스러운 심신(心身)이<b>여, 이</b>런 것을 풀고 진실로 기뻐하며 행복한 생각을 떠오른다. 임박할 30때가 될 호(好)실(實)때에 심신(心身)에 뭔가 바라느냐고 있는지 일시 결의(決意)하고 있기 때문에 다시 시골집에서 떠나겠고 희망한 학습(學習)에 잘 펴지며 창달(暢達)하고 긍정적인 의도(意圖)도 이루기기 위하여 자제력(自制力)을 발휘하려고 있는 능력을 뜻깊게 가지며 행복한 삶을 살 예정이다. 그리고 더 넓은 세상에서 누군가 만날 수 있는지, 어떤 것을 더 깔금하게 배우며 풀어낼 수 있는지 설레는 도전(挑戰)을 뜻깊게 가지며 행복며 단란(團欒)한 삶을 살겠다. 따라서 충심에서 용맹(勇猛)과 애정(愛情)만 나오기 때문에 성공적이고 행복한 30때에 대한 한철이 되겠다.<br> 
          -----
        </td>  
      </tr>  
      <tr>
